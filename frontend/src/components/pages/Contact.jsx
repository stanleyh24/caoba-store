        ...
        <div class="mb-12 w-full lg:mb-0">
          ...
          <div className='flex gap-10'>
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                <h4 class="text-dark mb-1 text-xl font-bold">Nuestra Direccion</h4>
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                <h4 class="text-dark mb-1 text-xl font-bold">Número de teléfono</h4>
                <p class="text-body-color text-base">+1 (809) 685-6425</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                <h4 class="text-dark mb-1 text-xl font-bold">Dirección de correo electrónico</h4>
                <p class="text-body-color text-base">ventas@caobacigars.com</p>
              </div>
            </div>
          </div>
        </div>
