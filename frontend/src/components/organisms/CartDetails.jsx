  ...
  return (
    <div className="md:w-1/2 bg-white px-10 py-10">
        <div className="flex justify-between border-b pb-8">
          <h1 className="font-semibold text-2xl secondary-color">Detalles de compra</h1>
          <h2 className="font-semibold text-2xl secondary-color">{cart.getNumberOfItems()} Articulos</h2>
        </div>
        ...
        <div className='flex justify-end'>
          <h2 className='text-2xl font-bold pr-2 secondary-color'>Total US:</h2>
          <p className='text-2xl font-bold secondary-color'>$ {cart.getTotalOfCart()}</p>
        </div>
