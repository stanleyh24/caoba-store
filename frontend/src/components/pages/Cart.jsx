  ...
  return (
    ...
    <div className="flex shadow-md my-10">
      <div id="summary" className="w-1/4 px-8 py-10 bg-white">
          <h1 className="font-semibold text-2xl border-b pb-8">Checkout</h1>
          ...
          <div className="mb-6">
            ...
            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear Orden</button>
          </form>
      </div>
      ...
      {/* <div id="summary" className="w-1/4 px-8 py-10">
        ...
        <div className="flex justify-between mt-10 mb-5">
          <span className="font-semibold text-sm uppercase">Items {state.cart.length}</span>
