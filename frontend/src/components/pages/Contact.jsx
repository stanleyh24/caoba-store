    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4">
        <div className="mb-12 w-full lg:mb-0">
          ...
          <p className="text-body-color mb-9 text-base leading-relaxed p-2">
            Si tiene alguna duda comuniquese con nosotros por la via de contacto de su eleccion.
          </p>
          <div className='md:flex md:gap-10'>
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                <h4 className="text-dark mb-1 text-xl font-bold">Nuestra Direccion</h4>
                <p className="text-body-color text-base">
                C/ El conde #101 local #9 Centro comercial Colon, Santo Domingo. R.D
                </p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                <h4 className="text-dark mb-1 text-xl font-bold">Número de teléfono</h4>
                <p className="text-body-color text-base">+1 (809) 685-6425</p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div className="w-full">
                <h4 className="text-dark mb-1 text-xl font-bold">Dirección de correo electrónico</h4>
                <p className="text-body-color text-base">ventas@caobacigars.com</p>
              </div>
            </div>
          </div>
        </div>
