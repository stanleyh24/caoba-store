  ...
  return (
    ...
    <div className="mx-6 text-center md:text-left mt-2">
        ...
        <div className="">
            ...
            <p>
                Somos un equipo de personas apasionadas por el tabaco y con el objetivo de crear solo los mejores cigarros con las mejores hojas de tabaco.
            </p>
        </div>
        <div className="">
        ...
        <div className="">
            ...
            C/ El conde #101 local #9 Centro comercial Colon
            </p>
            <p className="flex items-center justify-center md:justify-start mb-2">
